...
/**
 * wraps controls that will accept callbacks so the user will be able to
 * set dynamic ranges and values to modify the calendar component
 * @extends Component
 */
class CalendarControls extends Component {
  ...
  handleOnChange(event) {
    ...
    this.props._handleOnChange(event);
  }
